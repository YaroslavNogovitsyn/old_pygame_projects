...
mw = pygame.display.set_mode((700, 400))  # окно программы (main window)
mw.fill(back)
...
timer = Label(180, 20, 50, 40, back)
timer.set_text('0', 40, DARK_BLUE)
timer.draw(0, 0)

score = Label(550, 25, 50, 40, back)
...
while run:
    ...
    if not finished:
        ...
        if new_time - cur_time >= 1:  # проверяем, есть ли разница в 1 секунду между старым и новым временем
