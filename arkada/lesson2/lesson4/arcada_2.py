''' Доделали гравитацию - стр. 72 и 77. 
Теперь гравитация не накапливается, вертикальная скорость каждый раз обнуляется.
'''
        ...
        if self.y_speed > 0: # идем вниз
            for p in platforms_touched:
                self.y_speed = 0 # при столкновении со стеной вертикальная скорость гасится, 
                                 # гравитация в следующий раз будет применяться к нулевой начальной скорости 
