""" Поставили платформу внизу экрана, герой теперь не отталкивается автоматически от низа """
...
while run:
    ...
    bombs.draw(
        window)  # группу бомб рисуем отдельно - так бомба, которая ушла из своей группы, автоматически перестанет
    # быть видимой!
